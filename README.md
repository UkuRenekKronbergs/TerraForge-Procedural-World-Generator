...
- Nanite foliage pipeline for dense vegetation.
- Implemented upscaling and frame generation (FSR4 or DLSS4; both use frame gen + Balanced upscaling preset by default).
- Latency options enabled by default: AMD Anti-Lag 2, NVIDIA Reflex 2.

## Terrain & materials
- Terrain heightmap: Stamplt heightmap.
